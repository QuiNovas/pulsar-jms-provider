...
public class MessageGroup {
    ...
    public static AbstractMessage createInstance( byte type )
    {
        switch (type)
        {
            case EMPTY:  return new PulsarEmptyMessage();
            case BYTES:  return new PulsarBytesMessage();
            case MAP:    return new PulsarMapMessage();
            case OBJECT: return new PulsarObjectMessage();
            case STREAM: return new PulsarStreamMessage();
            case TEXT:   return new PulsarTextMessage();
